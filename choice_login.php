      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            <h2 class="card-title text-center mb-5 fw-bold fs-10">Login</h2>
            <h2 class="card-title text-center mb-5 fw-bold fs-10">Siapakah Kamu??</h2>
            <div style="padding: top 50px;px" class="panel-body" >

                <div class="d-grid">
                    <a href="login.php" class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-5" type="button" value="USER">USER</a>
                    <a href="login_admin.php" class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-5" type="button" value="USER">ADMIN</a>
                </div>

            <h2 class="card-title text-center mb-4 fw-light fs-5">Light Novel World</h2>
